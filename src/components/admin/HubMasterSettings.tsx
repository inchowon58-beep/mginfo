    ...
    <div className="settings-stack">
      ...
      <div className="admin-card" style={{ maxWidth: 640 }}>
        ...
        <p style={{ color: "#94a3b8", fontSize: 14, lineHeight: 1.7 }}>
          글 하단과 사이트 푸터에 정보 제공·면책 문구가 붙습니다. 푸터 짧은 문구는 사이트마다 다르게 잡히며, 각
          사이트 관리자 「기본설정」에서 바꿀 수 있습니다. 금지 키워드는 새로 쓰는 글과 이미 발행된 글을 같이 막습니다.
          다만 프로그램 문구만으로 법적 책임이 완전히 사라지지는 않습니다. 허위·불법·음란·사행 글은 올리지 않는 것이
          가장 확실한 보호입니다.
        </p>
      </div>
    </div>
